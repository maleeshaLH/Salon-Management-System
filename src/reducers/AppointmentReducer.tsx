...
export const getAllAppointmentCount = createAsyncThunk(
    'appointment/getAllAppointmentCount',
    async () => {
        try {
...
export  const appointmentSlice = createSlice({
    ...
    extraReducers:(builder) =>{
        ...
        builder
            .addCase(getAllAppointmentCount.pending,(state,action) =>{
                console.log("pending",action.payload)
            })
            .addCase(getAllAppointmentCount.rejected,(state,action) =>{
                console.log("rejected",action.payload)
            })
            .addCase(getAllAppointmentCount.fulfilled,(state,action) =>{
                console.log("fulfilled",action.payload)
                return action.payload
            })
